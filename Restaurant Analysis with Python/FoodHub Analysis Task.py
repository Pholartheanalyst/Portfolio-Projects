...
maxDeliveryTime = foodhub[['day_of_the_week','delivery_time']].groupby('day_of_the_week').max()

minDeliveryTime = foodhub[['day_of_the_week','delivery_time']].groupby('day_of_the_week').min()
